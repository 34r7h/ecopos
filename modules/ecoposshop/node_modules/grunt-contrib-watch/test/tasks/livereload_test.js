...
exports.livereload = {
  ...
  basic: function(test) {
    ...
    assertWatch([function() {
      ...
      test.ok(result.indexOf('Live reload server started on port: 35733') !== -1, 'live reload server should have been started on port 35733.');
  ...
  customport: function(test) {
    ...
    assertWatch([function() {
      ...
      helper.verboseLog(result);
      test.ok(result.indexOf('I ran before livereload.') !== -1, 'task should have ran before live reload.');
      test.ok(result.indexOf('Live reload server started on port: 8675') !== -1, 'live reload server should have been started on port 35733.');
      test.ok(result.indexOf('Live reloading lib/one.js...') !== -1, 'live reload should have triggered on lib/one.js');
      resultData = JSON.parse(resultData);
      test.equal(resultData.tinylr, 'Welcome', 'tinylr server should have welcomed you.');
      test.done();
  ...
  multiplefiles: function(test) {
    ...
    assertWatch([function() {
      ...
      helper.verboseLog(result);
      test.ok(result.indexOf('I ran before livereload.') !== -1, 'task should have ran before live reload.');
      test.ok(result.indexOf('Live reload server started on port: 9876') !== -1, 'live reload server should have been started on port 35733.');
