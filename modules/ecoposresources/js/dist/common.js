...
angular.module('ecopos.common').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('directive/login/login.html',
    "<div><div style=\"text-align: right\" class=\"panel panel-default panel-body\"><div class=user-block data-ng-show=user.uid><span data-ng-show=user.displayName>Logged in as: {{ user.displayName }}<span data-ng-show=user.loginService>&nbsp;via {{ user.loginService }}</span><span data-ng-show=user.id>&nbsp;(#{{ user.id }})</span></span> <span><input type=button value=Logout data-ng-click=logout()></span></div><div class=profile-block data-ng-show=user.uid><span><label for=displayName>Name:</label><input name=displayName id=displayName data-ng-model=user.displayName></span> <span><input type=button value=\"Save Profile\" data-ng-click=saveUserData()></span></div><div class=anonymous-block data-ng-hide=user.uid><div class=register-block ng-show=reg><div class=col-lg-3><label for=email>Email:</label><input name=email id=email data-ng-model=email></div><div class=col-lg-3><label for=password>Password:</label><input type=password name=password id=password data-ng-model=password></div><div class=col-lg-3><span><label for=passwordConfirm>Confirm password:</label><input type=password name=passwordConfirm id=passwordConfirm data-ng-model=passwordConfirm></span></div><div class=col-lg-2><label></label><input type=button value=\"Create User\" data-ng-click=addUser()></div><div class=col-lg-12><a ng-href=# ng-click=\"reg=false\">Already Registered?</a></div></div><div class=login-block ng-hide=reg><div class=col-lg-5><label for=email>Email:</label><input name=email id=email data-ng-model=email></div><div class=col-lg-6><span><label for=password>Password:</label><input type=password name=password id=password data-ng-model=password></span> <span><input type=button value=Login data-ng-click=login()></span></div><div class=col-lg-1></div><br><br><div><span class=col-lg-4><input type=button value=\"Login with Facebook\" data-ng-click=loginFacebook()></span> <span class=col-lg-3><input type=button value=\"Login with Twitter\" data-ng-click=loginTwitter()></span> <span class=col-lg-3><input type=button value=\"Login with GitHub\" data-ng-click=loginGitHub()></span> <span class=col-lg-2><a ng-href=# ng-click=\"reg=true\">Register?</a></span></div></div></div></div></div>"
  );
