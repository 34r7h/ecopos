...
if(!COMPILED && goog.ENABLE_DEBUG_LOADER) {
 ...
 //   goog.importScript_(goog.basePath + "deps.js") // TODO: what is this?  why is it 404?
  }
}
...
FirebaseTokenGenerator = function(secret) {
  fb.util.validation.validateArgCount("new FirebaseTokenGenerator", 1, 1, arguments.length);
...
FirebaseTokenGenerator.prototype.createToken = function(data, options) {
  ...
  fb.util.validation.validateArgCount(funcName, 1, 2, arguments.length);
...
FirebaseTokenGenerator.prototype.createToken_ = function(claims) {
  ...
  var encodedHeader = this.noPadWebsafeBase64Encode_(fb.util.json.stringify(headerData));
  var encodedClaims = this.noPadWebsafeBase64Encode_(fb.util.json.stringify(claims));
